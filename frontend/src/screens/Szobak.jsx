...
const Szobak = () => {
    ...
    const handleInputChange = (event) => {
        ...
        if (value === 'on') {
            // console.log(currentRoom.extrak);
            currentRoom.extrak[Number(id[6])] =
                !currentRoom.extrak[Number(id[6])];
            // console.log(currentRoom.extrak);
            setCurrentRoom({ ...currentRoom, extrak: currentRoom.extrak });
        }
    };
            ...
            >
                ...
                <Modal.Footer>
                    <Button
                        variant="primary"
                        onClick={() =>
                            handleUpdate(currentRoom && currentRoom._id)
                        }
                    >
                        Frissít
                    </Button>
